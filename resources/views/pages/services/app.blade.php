...
@section('title')
App Development Services | UXD Consults
@endsection
...
<!-- Banner Section -->
          ...
          <div class="auto-container">
            ...
            <div class="sec-title centered custom text">
              <h2 class="mb-2 main-heading-services"><span class="text-initial text-light"><b>Partner up</b> with
                  the <b>Best App Development <br> Agency in</b><span class="text-initial text-black theme-color"> UK</span>
                </span>
              </h2>
        ...
        <section class="we-work-section">
          <div class="auto-container">
            <div class="sec-title centered custom text">
              <h3><span class="text-light">We are Creating <span class="text-black theme-color">PROFESSIONAL CUSTOMIZED
                    APPLICATIONS</span> for you.</span></h3>
              <h2></h2>
            </div>
            <div class="text centered">
              <p class="pera">We ensure success with our mobile app development services. Tech6 Solutions is one of the most
                professional app
                development businesses in the United States. Our capability is increasing every day and making us better able to
                serve
                you more efficiently.</p>
              <p class="pera"><b>uxd Consults Our technological team will collaborate with you to develop dynamic mobile
                  applications.</b>
            </div>
            <div class="col-md-12">
        ...
        <section class="we-work-section">
          <div class="auto-container">
            <div class="sec-title centered">
              <h2 data-aos="fade-up" class="main-heading-services"><span class="line-break text-black theme-color mb-2">APP
                  | DEVELOPMENT</span></h2>
              <h4><span class="text-light letter-spacing-1"><span class="text-black theme-color">UXD
                    Consults</span> Offers Modern App Development Solutions.</span></h4>
              <p class="pera"><b>Our technological team will collaborate with you to develop dynamic mobile applications.
                </b></p>
              </h4>
            </div>
            <div class="row clearfix">
